...
This vignette demonstrates how to use the `SPASAM.MSE` (Woods Hole Assessment Model Management Strategy Evaluation) package to apply different types of harvest control rule (HCR) in a management strategy evaluation (MSE). **Note:** all code shown here is for demonstration purposes only; the results are for illustrative use and should not be interpreted as reflecting real-world stock assessments.
...
```
![Figure 1](Example_plots/HCR_plot.png){width="600"}