...
This vignette demonstrates how to use the `SPASAM.MSE` (Woods Hole Assessment Model Management Strategy Evaluation) package to conduct management strategy evaluation. **Note:** all code shown here is for demonstration purposes only; the results are for illustrative use and should not be interpreted as reflecting real-world stock assessments.
...
The "SPASAM.MSE" package has comprehensive output analysis tools (see
