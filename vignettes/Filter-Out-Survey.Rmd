...
mod1$em_input[[1]]$data$agg_indices # double check if a index is removed from the EM
mod1$em_input[[1]]$data$index_regions # double check if 2 indices in region 1 and only 1 index in region 2 in the EM
...
mod2$em_input[[1]]$data$agg_indices # double check if a index is removed from the EM
mod2$em_input[[1]]$data$index_regions # double check if 2 indices in region 2 and only 1 index in region 1 in the EM
