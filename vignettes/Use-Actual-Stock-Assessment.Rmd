...
output to develop an operating model (OM) for `SPASAM.MSE`, while keeping the
...
`SPASAM.MSE`. In addition, this workflow has only been tested for cases where
...
```{r, eval=FALSE}
gb_file <- system.file("extdata", "GBK.DAT", package = "SPASAM.MSE")
gb_dat <- read_asap3_dat(gb_file)
...
![Figure 1](Example_plots/actual_assessment_plot1.png){width="600"}
...
# Panel 3 — predicted NAA age 6
plot(
  om_future$rep$pred_NAA[s, r, , 6],
  type = "l",
  main = "Predicted Number at Age 6",
  xlab = "Model year",
  ylab = "Predicted NAA age 6"
)
abline(v = first_free_year, lty = 2, col = "red")
```

![Figure 2](Example_plots/actual_assessment_plot2.png){width="600"}
...
![Figure 3](Example_plots/actual_assessment_plot3.png){width="600"}
...
![Figure 4](Example_plots/actual_assessment_plot4.png){width="600"}
...
```
![Figure 5](Example_plots/actual_assessment_plot5.png){width="600"}
