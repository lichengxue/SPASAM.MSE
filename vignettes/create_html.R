...
main_dev_html <- sprintf(
  paste0(
    ...
    '<span class="main-dev-label">Main developer</span>: ',
...
index_out <- c(
  ...
  '    .main-dev-label{font-size:20px;font-weight:800;color:var(--text);}',
  '    .main-dev-name{font-size:20px;font-weight:900;color:var(--text);line-height:1.1;}',
