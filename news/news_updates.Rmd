...
news_updates <- list(
  list(date = "2026-06-23", title = "Version 1.1.4 Released", content = "Improve MSE results reporting, including more robust BRP-dependent plotting, report generation, and handling of missing or non-finite plotting values."),
